<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"/Users/panliu/Documents/project/ozz/ozzw/addons/cms/view/default2/channel_contact.html";i:1676805597;s:81:"/Users/panliu/Documents/project/ozz/ozzw/addons/cms/view/default2/common/top.html";i:1676706692;s:81:"/Users/panliu/Documents/project/ozz/ozzw/addons/cms/view/default2/common/mbx.html";i:1676707440;s:82:"/Users/panliu/Documents/project/ozz/ozzw/addons/cms/view/default2/common/foot.html";i:1676805485;}*/ ?>
...
$.post('./?do_action=action.currency',{currency:data},function(data){
  ...
  <div class="header_box">
      ...
      <div class="nav_bar"><div class="default_nav_style">
        <?php $__DuCi8UI3ly__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__DuCi8UI3ly__) || $__DuCi8UI3ly__ instanceof \think\Collection || $__DuCi8UI3ly__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__DuCi8UI3ly__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                ...
                <div class="nav_sec_box">
                  <div class="">
                     <div id="nav_sec_4" class="nav_list">
                            <?php $__6kSrwy82OL__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","condition"=>"1=isnav","typeid"=>$nav['id'],"cache"=>"0","row"=>"20"]); if(is_array($__6kSrwy82OL__) || $__6kSrwy82OL__ instanceof \think\Collection || $__6kSrwy82OL__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__6kSrwy82OL__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
                              ...
                              <dd class="nav_thd_list">
                                <?php $__Cmt5yUcMdY__ = \addons\cms\model\Archives::getArchivesList(["id"=>"sonshow","channel"=>$son['id'],"orderby"=>"weigh","orderway"=>"desc","row"=>"20"]); if(is_array($__Cmt5yUcMdY__) || $__Cmt5yUcMdY__ instanceof \think\Collection || $__Cmt5yUcMdY__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Cmt5yUcMdY__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sonshow): $mod = ($i % 2 );++$i;?>
                                    ...
                                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__Cmt5yUcMdY__; if($son['has_child']): $__B39Jc1wdzu__ = \addons\cms\model\Channel::getChannelList(["id"=>"sons","condition"=>"1=isnav","type"=>"son","typeid"=>$son['id'],"cache"=>"0"]); if(is_array($__B39Jc1wdzu__) || $__B39Jc1wdzu__ instanceof \think\Collection || $__B39Jc1wdzu__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__B39Jc1wdzu__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sons): $mod = ($i % 2 );++$i;?>
                                    <div class="nav_thd_item">
                                        <a href="<?php echo $sons['url']; ?>" title="<?php echo $sons['name']; ?>"><?php echo $sons['name']; ?></a>
                                    </div>
                                    
                                  <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__B39Jc1wdzu__; endif; ?>
                              </dd>
                              </dl>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__6kSrwy82OL__; ?>
                     </div>
                     </div>
                     </div>
                     </div>
        ...
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__DuCi8UI3ly__; ?>
  </div>
...
<div class="article-content wrap-module">
		<div class="in_ad">
	<div class="bxSlide-outter" style="overflow:hidden;margin-left:auto;margin-right:auto; width:1920px; max-width:100%; max-height:350px">
</div>			<div class="ad_con">
		<div class="con_table">
			<div class="con_table_cell">
			<div class="ueeshop_responsive_position clean ">
<div class="title"><?php echo $__CHANNEL__['name']; ?></div>
<div class="position">
	<?php $__u7wTSxH0vo__ = \addons\cms\model\Channel::getBreadcrumb($__CHANNEL__??[], $__ARCHIVES__??[], $__TAGS__??[], $__PAGE__??[], $__DIYFORM__??[]); if(is_array($__u7wTSxH0vo__) || $__u7wTSxH0vo__ instanceof \think\Collection || $__u7wTSxH0vo__ instanceof \think\Paginator): $k = 0; $__LIST__ = $__u7wTSxH0vo__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;if($k>1): ?> &gt; <?php endif; ?><a title="<?php echo $item['name']; ?>" href="<?php echo $item['url']; ?>"><?php echo $item['name']; ?></a>
  <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__u7wTSxH0vo__; ?>
</div>
</div>					</div>
		</div>
	</div>
		...
		<div class="wrap menu-in-left">
			<div class="art-title">Contact Us</div>
			<div class="contenter">
	...
	<div class="detail_module_4">
	<div class="graphic">
	<div class="text_park">
	<div><span style="color:#000000;"><span style="font-family:quattrocentosans-regular;"><strong><span style="font-size:22px;">Please feel free to contact us<br>
	Mutual benefit, cooperation and progress</span></strong></span></span></div>
	
	<div class="con_p">
		<?php $__TWHXDSqFUx__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"contact","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__TWHXDSqFUx__) || $__TWHXDSqFUx__ instanceof \think\Collection || $__TWHXDSqFUx__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__TWHXDSqFUx__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;if($block['title'] == 'Phone'): ?>
			<span style="color:#000000;"><strong><?php echo $block['title']; ?>：</strong></span><a href="tel: <?php echo str_replace(['<p>','</p>'], '', $block['content']); ?>"><span style="color:#0000FF;"><?php echo str_replace(['<p>','</p>'], '', $block['content']); ?></span></a><br>
			<?php endif; if($block['title'] == 'Email'): ?>
			<span style="color:#000000;"><strong><?php echo $block['title']; ?>：</strong></span><a href="mailto: <?php echo str_replace(['<p>','</p>'], '', $block['content']); ?>"><span style="color:#0000FF;"><?php echo str_replace(['<p>','</p>'], '', $block['content']); ?></span></a><br>
			<?php endif; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__TWHXDSqFUx__; $__MfZ5sWF4Yl__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"contact","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__MfZ5sWF4Yl__) || $__MfZ5sWF4Yl__ instanceof \think\Collection || $__MfZ5sWF4Yl__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__MfZ5sWF4Yl__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;if($block['title'] != 'Email'): if($block['title'] != 'Phone'): ?>
			<span style="color:#000000;"><strong><?php echo $block['title']; ?>：</strong></span><span><?php echo str_replace(['<p>','</p>'], '', $block['content']); ?></span><br>
			<?php endif; endif; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__MfZ5sWF4Yl__; ?>
	</div>
	</div>
	...
	<div class="text_park">
	<div class="center_text_title">&nbsp;</div>
	</div>
	</div>
	...
	<style type="text/css">.detail_module_4 .graphic { max-width: 1160px; margin: 0 auto; }
				.detail_module_4 .graphic .img_park { width: 46.035%; float: right;}
				.detail_module_4 .graphic .text_park { width: 50%; margin-top: 20px; float: left;}
				...
				@media screen and (max-width: 768px){
					.detail_module_4 .graphic .img_park { width: 100%; margin-top: 10px; float: unset;}
					.detail_module_4 .graphic .text_park { width: 100%; margin-top: 12px; float: unset;}
	...
	<div class="addthis_sharing_toolbox"></div>
		...
		<form method="post" name="feedback1" onsubmit="return $('.formPoint').show();" method="POST" action="/d/customer/post.html">
			<input type="hidden" name="__diyname__" value="customer">
			<?php echo token(); ?>
									<div class="rows input_rows">
			<label><span>*</span> Company</label>
			<span><input name="row[company]" type="text" class="input" size="30" maxlength="100" notnull=""></span>
			<div class="clear"></div>
		</div>
										<div class="rows input_rows">
			<label>Phone</label>
			<span><input name="row[telephone]" type="text" class="input" size="30" maxlength="20"></span>
			<div class="clear"></div>
		</div>
														<div class="rows input_rows">
			<label><span>*</span> Email</label>
			<span><input name="row[email]" type="text" class="input" size="30" maxlength="100" format="Email" notnull=""></span>
			<div class="clear"></div>
		</div>
  ...
  <div class="footer_box">
    <div class="list_item">
          ...
          <ul>
            ...
            <?php $__ClEB5c6uGy__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","condition"=>"1=isnav","typeid"=>"44","cache"=>"0","row"=>"20"]); if(is_array($__ClEB5c6uGy__) || $__ClEB5c6uGy__ instanceof \think\Collection || $__ClEB5c6uGy__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__ClEB5c6uGy__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
            <li class="item_content"><a href="<?php echo $son['url']; ?>" title="<?php echo $son['name']; ?>"><?php echo $son['name']; ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__ClEB5c6uGy__; ?>
                        </ul>
        </div>
                <div class="ft_item">
          <ul>
            ...
            <li class="item_content"><a href="/Contact-us" title="Contact Us">Contact Us</a></li>
                        </ul>
        </div>
                <div class="ft_item">
          <ul>
            ...
            <?php $__O9z23GtAZg__ = \addons\cms\model\Archives::getArchivesList(["id"=>"new","channel"=>"66","flag"=>"index","orderby"=>"weigh","orderway"=>"desc","row"=>"20","addon"=>"content"]); if(is_array($__O9z23GtAZg__) || $__O9z23GtAZg__ instanceof \think\Collection || $__O9z23GtAZg__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__O9z23GtAZg__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?>}
              <li class="item_content"><a href="{new.url}" title="<?php echo $new['title']; ?>"><?php echo $new['title']; ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__O9z23GtAZg__; ?>
                        </ul>
        </div>
              <div class="ft_item">
        <ul>
          ...
          <li class="item_content">
            ...
            <?php $__VU1Al8fOcd__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"FollowUs","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__VU1Al8fOcd__) || $__VU1Al8fOcd__ instanceof \think\Collection || $__VU1Al8fOcd__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__VU1Al8fOcd__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
              <a href="<?php echo $block['url']; ?>" target="_blank" class="foot_share_box <?php echo $block['title']; ?>"></a>
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__VU1Al8fOcd__; ?>
            </div></li>
        </ul>
      </div>
    </div>
    <div class="clear"></div>
      ...
      <div class="right_text">
        <?php $__mCTySNVW5E__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav1","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__mCTySNVW5E__) || $__mCTySNVW5E__ instanceof \think\Collection || $__mCTySNVW5E__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__mCTySNVW5E__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav1): $mod = ($i % 2 );++$i;?>
          <span><a href="<?php echo $nav1['url']; ?>" title="<?php echo $nav1['name']; ?>"><?php echo $nav1['name']; ?></a></span>
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__mCTySNVW5E__; ?>
                </div>
    </div>
  </div>
</div>
