<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/Users/panliu/Documents/project/ozz/ozzw/addons/cms/view/default2/list_product.html";i:1676725868;s:81:"/Users/panliu/Documents/project/ozz/ozzw/addons/cms/view/default2/common/top.html";i:1676706692;s:81:"/Users/panliu/Documents/project/ozz/ozzw/addons/cms/view/default2/common/mbx.html";i:1676707440;s:82:"/Users/panliu/Documents/project/ozz/ozzw/addons/cms/view/default2/common/foot.html";i:1676805485;}*/ ?>
...
$.post('./?do_action=action.currency',{currency:data},function(data){
  ...
  <div class="header_box">
      ...
      <div class="nav_bar"><div class="default_nav_style">
        <?php $__helc63NvzL__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__helc63NvzL__) || $__helc63NvzL__ instanceof \think\Collection || $__helc63NvzL__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__helc63NvzL__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                ...
                <div class="nav_sec_box">
                  <div class="">
                     <div id="nav_sec_4" class="nav_list">
                            <?php $__geLa3NbvGX__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","condition"=>"1=isnav","typeid"=>$nav['id'],"cache"=>"0","row"=>"20"]); if(is_array($__geLa3NbvGX__) || $__geLa3NbvGX__ instanceof \think\Collection || $__geLa3NbvGX__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__geLa3NbvGX__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
                              ...
                              <dd class="nav_thd_list">
                                <?php $__tuDapOzX0T__ = \addons\cms\model\Archives::getArchivesList(["id"=>"sonshow","channel"=>$son['id'],"orderby"=>"weigh","orderway"=>"desc","row"=>"20"]); if(is_array($__tuDapOzX0T__) || $__tuDapOzX0T__ instanceof \think\Collection || $__tuDapOzX0T__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__tuDapOzX0T__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sonshow): $mod = ($i % 2 );++$i;?>
                                    ...
                                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__tuDapOzX0T__; if($son['has_child']): $__bIrPUdoYhw__ = \addons\cms\model\Channel::getChannelList(["id"=>"sons","condition"=>"1=isnav","type"=>"son","typeid"=>$son['id'],"cache"=>"0"]); if(is_array($__bIrPUdoYhw__) || $__bIrPUdoYhw__ instanceof \think\Collection || $__bIrPUdoYhw__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__bIrPUdoYhw__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sons): $mod = ($i % 2 );++$i;?>
                                    <div class="nav_thd_item">
                                        <a href="<?php echo $sons['url']; ?>" title="<?php echo $sons['name']; ?>"><?php echo $sons['name']; ?></a>
                                    </div>
                                    
                                  <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__bIrPUdoYhw__; endif; ?>
                              </dd>
                              </dl>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__geLa3NbvGX__; ?>
                     </div>
                     </div>
                     </div>
                     </div>
        ...
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__helc63NvzL__; ?>
  </div>
...
<div class="position">
	<?php $__8Cuvbz9c1A__ = \addons\cms\model\Channel::getBreadcrumb($__CHANNEL__??[], $__ARCHIVES__??[], $__TAGS__??[], $__PAGE__??[], $__DIYFORM__??[]); if(is_array($__8Cuvbz9c1A__) || $__8Cuvbz9c1A__ instanceof \think\Collection || $__8Cuvbz9c1A__ instanceof \think\Paginator): $k = 0; $__LIST__ = $__8Cuvbz9c1A__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;if($k>1): ?> &gt; <?php endif; ?><a title="<?php echo $item['name']; ?>" href="<?php echo $item['url']; ?>"><?php echo $item['name']; ?></a>
  <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__8Cuvbz9c1A__; ?>
</div>
</div>					</div>
		</div>
	</div>
...
<div class="pro_list">
	<div class="wrap">
		<div class="text-center cate-name">
			...
			<div class="ueeshop_responsive_products_filter_mb ueeshop_responsive_products_filter_ns">
</div>

<div class="ueeshop_responsive_products_list ">
<?php $__wtVX4HRAeZ__ = $__PAGELIST__; if(is_array($__wtVX4HRAeZ__) || $__wtVX4HRAeZ__ instanceof \think\Collection || $__wtVX4HRAeZ__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__wtVX4HRAeZ__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
<div class="item">
	<div class="pro">
		<div class="img pic_box">
			<a href="<?php echo $item['url']; ?>" target="_blank" title="<?php echo $item['title']; ?>">
			<img data-src="<?php echo $item['image']; ?>" class="trans5 delay loading_img" alt="<?php echo $item['title']; ?>"><em></em>
			</a>
		</div>
		<div class="info">
			<h3 class="name"><a href="<?php echo $item['url']; ?>" title="<?php echo $item['title']; ?>" target="_blank"><?php echo $item['title']; ?></a></h3>
								<a href="<?php echo $item['url']; ?>" target="_blank" title="<?php echo $item['title']; ?>" class="more">View More</a>
		</div>
		<div class="clear"></div>
	</div>
	<div class="img_list pro_img_list">
					</div>
</div>
<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__wtVX4HRAeZ__; ?>
<div class="clear"></div>
	<div class="ueeshop_responsive_turn_page ">
		...
		<div class="hot_cate">
			...
			<div class="list slider">
						<?php $__2AKGrPVI3n__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","typeid"=>"44","cache"=>"0","row"=>"20"]); if(is_array($__2AKGrPVI3n__) || $__2AKGrPVI3n__ instanceof \think\Collection || $__2AKGrPVI3n__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__2AKGrPVI3n__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;$__3yQdNxVjFO__ = \addons\cms\model\Archives::getArchivesList(["id"=>"itemHot","channel"=>$son['id'],"flag"=>"hot","orderby"=>"weigh","orderway"=>"desc","row"=>"20","addon"=>"content"]); if(is_array($__3yQdNxVjFO__) || $__3yQdNxVjFO__ instanceof \think\Collection || $__3yQdNxVjFO__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__3yQdNxVjFO__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$itemHot): $mod = ($i % 2 );++$i;?>}
							<div class="row slide">
								<a class="img" href="<?php echo $itemHot['url']; ?>"><img class="trans loading_img" data-src="<?php echo $itemHot['image']; ?>" alt=""></a>
								<div class="row_txt">
									<a class="name trans" href="<?php echo $itemHot['url']; ?>"><?php echo $itemHot['title']; ?></a>
								</div>
								<div class="clear"></div>
							</div>
						<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__3yQdNxVjFO__; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__2AKGrPVI3n__; ?>
			</div>
		</div>
	</div>
</div>
  ...
  <div class="footer_box">
    <div class="list_item">
          ...
          <ul>
            ...
            <?php $__gy9p1EwCKd__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","condition"=>"1=isnav","typeid"=>"44","cache"=>"0","row"=>"20"]); if(is_array($__gy9p1EwCKd__) || $__gy9p1EwCKd__ instanceof \think\Collection || $__gy9p1EwCKd__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__gy9p1EwCKd__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
            <li class="item_content"><a href="<?php echo $son['url']; ?>" title="<?php echo $son['name']; ?>"><?php echo $son['name']; ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__gy9p1EwCKd__; ?>
                        </ul>
        </div>
                <div class="ft_item">
          <ul>
          ...
          <ul>
            ...
            <?php $__9fZc42nbjP__ = \addons\cms\model\Archives::getArchivesList(["id"=>"new","channel"=>"66","flag"=>"index","orderby"=>"weigh","orderway"=>"desc","row"=>"20","addon"=>"content"]); if(is_array($__9fZc42nbjP__) || $__9fZc42nbjP__ instanceof \think\Collection || $__9fZc42nbjP__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__9fZc42nbjP__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?>}
              <li class="item_content"><a href="{new.url}" title="<?php echo $new['title']; ?>"><?php echo $new['title']; ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__9fZc42nbjP__; ?>
                        </ul>
        </div>
              <div class="ft_item">
        <ul>
          ...
          <li class="item_content">
            ...
            <?php $__e2jLWbU1z5__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"FollowUs","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__e2jLWbU1z5__) || $__e2jLWbU1z5__ instanceof \think\Collection || $__e2jLWbU1z5__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__e2jLWbU1z5__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
              <a href="<?php echo $block['url']; ?>" target="_blank" class="foot_share_box <?php echo $block['title']; ?>"></a>
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__e2jLWbU1z5__; ?>
            </div></li>
        </ul>
      </div>
    </div>
    <div class="clear"></div>
      ...
      <div class="right_text">
        <?php $__iWDvKkBJha__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav1","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__iWDvKkBJha__) || $__iWDvKkBJha__ instanceof \think\Collection || $__iWDvKkBJha__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__iWDvKkBJha__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav1): $mod = ($i % 2 );++$i;?>
          <span><a href="<?php echo $nav1['url']; ?>" title="<?php echo $nav1['name']; ?>"><?php echo $nav1['name']; ?></a></span>
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__iWDvKkBJha__; ?>
                </div>
    </div>
  </div>
</div>
