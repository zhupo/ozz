<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:103:"/Users/pan.liu/Documents/privateProject/ozz/ozzw/public/../application/admin/view/cms/archives/add.html";i:1676543408;s:91:"/Users/pan.liu/Documents/privateProject/ozz/ozzw/application/admin/view/layout/default.html";i:1676543408;s:88:"/Users/pan.liu/Documents/privateProject/ozz/ozzw/application/admin/view/common/meta.html";i:1676543408;s:96:"/Users/pan.liu/Documents/privateProject/ozz/ozzw/application/admin/view/cms/archives/common.html";i:1676543408;s:90:"/Users/pan.liu/Documents/privateProject/ozz/ozzw/application/admin/view/common/script.html";i:1676543408;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="basic">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class="input-group">
                                        <input id="c-title" data-rule="required" class="form-control" name="row[title]" type="text" value="" data-suggestion-url="<?php echo url('cms.archives/suggestion'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class="input-group">
                                        <input id="c-image" class="form-control" size="50" name="row[image]" type="text" value="" placeholder="缩略图,可以为空">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class="input-group">
                                        <input id="c-images" class="form-control" size="50" name="row[images]" type="text" value="" placeholder="组图,可以为空">
                                        <div class="input-group-addon no-border no-padding">
                       ...
                       <!--这里自定义图片预览的模板 开始-->
                        ...
                        <!--这里自定义图片预览的模板 结束-->
                            ...
                            <div class="form-group hide">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <input id="c-tags" data-rule="" class="form-control" placeholder="多个关键词以,隔开 输入后空格确认,可以为空" name="row[tags]" type="text" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <input type="text" id="c-diyname" data-rule="diyname" name="row[diyname]" class="form-control" placeholder="请输入自定义URL名称" data-tip="用于伪静态规则中[:diyname]替换"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="c-content" class="control-label col-xs-12 col-sm-2"><?php echo __('Content'); ?>:</label>
                                <div class="col-xs-12 col-sm-8">
                                    <textarea id="c-content" data-rule="" class="form-control editor" name="row[content]" rows="20"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <textarea id="c-description" cols="60" rows="3" data-rule="" class="form-control" name="row[description]"></textarea>
                                </div>
                            </div>
                            <div id="extend"></div>
                        </div>
